...
class HealthDeviceService {
  ...
  Future<bool> sendMedicationSignal(int signal) async {
    if (!_bluetoothService.isConnected) {
      return false;
    }
    // Sending the signal digit followed by a newline for the ESP32 to parse
    return await _bluetoothService.sendCommand('$signal\n');
  }
  ...
  void _parseData(String message) {
    try {
      ...
      // Print removed for production code compliance
    }
  }
